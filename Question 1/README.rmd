...
```{r,  echo = FALSE, warning =  TRUE, fig.align = 'center', fig.cap = "The Proportion of the Top 25 Baby Names and their Persistence Over Time for both Genders\\label{Figure3}", fig.ext = 'png', fig.height = 5, fig.width = 7}

g2 <- plot_name_persistence_heatmap(Girl_Baby_Names_df, Boy_Baby_Names_df)
g2

```
The figure above showcases the persistence of the most popular baby names from a given dataset. The color gradient from white to blue represents the presence of a name in the top 25 baby names for each year, with darker shades of blue indicating higher persistence. Notable names such as "Jessica," "Jennifer," and "Emily" show strong persistence over the years, particularly in the 1980s and 1990s.
...
```{r,  echo = FALSE, warning =  TRUE, fig.align = 'center', fig.cap = "The Number of Years the Top 25 Baby Names Persisted Over Time for both Genders\\label{Figure4}", fig.ext = 'png', fig.height = 5, fig.width = 7}

g3 <- plot_name_persistence_summary(Girl_Baby_Names_df, Boy_Baby_Names_df)
g3
...
```{r,  echo = FALSE, warning =  TRUE, fig.align = 'center', fig.cap = "The Number of Years the Top 25 Baby Names Persisted Over Time for both Genders\\label{Figure5}", fig.ext = 'png', fig.height = 5, fig.width = 7}


g4 <- plot_HBO_name_persistence(combined_result_final_top_25_names)
g4
