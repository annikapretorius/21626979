...
- **Table \ref{tab1}**:
  ...
  - Presents a detailed summary of the financial allocations made by EU countries to Ukraine, with the first column a reference to the total amount allocated by the EU. 
